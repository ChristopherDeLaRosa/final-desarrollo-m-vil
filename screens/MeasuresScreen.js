      ...
      >
        ...
        <View style={styles.content}>
          <Text style={styles.subtitle}>
            Conoce las políticas y medidas que implementamos para proteger
                ...
                <Card.Content style={styles.measureContent}>
                  <View style={styles.measureHeader}>
                    <View style={styles.chipsContainer}>
                      <Chip
                        style={[
                          styles.chip,
                          {
                            backgroundColor: getCategoryColor(measure.category)
                          }
                        ]}
                      ...
                      <Chip
                        style={[
                          styles.chip,
                          {
                            backgroundColor: getPriorityColor(measure.priority)
                          }
                        ]}
                        textStyle={styles.chipText}
                      >
                    ...
                    <Chip
                      style={[
                        styles.chip,
                        { backgroundColor: getStatusColor(measure.status) }
                      ]}
                      textStyle={styles.chipText}
                    >
                      {measure.status}
                  ...
                  <Paragraph style={styles.measureDescription}>
                    {measure.description}
                  </Paragraph>
