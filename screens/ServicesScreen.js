      ...
      const mockServices = [
        {
          ...
          title: 'Evaluación de Impacto Ambiental',
          description:
            'Evaluamos proyectos para determinar su impacto ambiental y las medidas de mitigación necesarias.',
          icon: '📋'
        },
        {
          id: 2,
          title: 'Licencias Ambientales',
          description:
            'Otorgamos licencias para actividades que puedan afectar el medio ambiente.',
          icon: '📜'
        },
        {
          id: 3,
          title: 'Monitoreo de Calidad del Aire',
          description:
            'Supervisamos la calidad del aire en diferentes zonas del país.',
          icon: '🌬️'
        },
        {
          id: 4,
          title: 'Gestión de Residuos Sólidos',
          description:
            'Asesoramos en el manejo adecuado de residuos sólidos urbanos e industriales.',
          icon: '♻️'
        },
        {
          id: 5,
          title: 'Protección de Recursos Hídricos',
          description:
            'Velamos por la conservación y uso sostenible de nuestros recursos de agua.',
          icon: '💧'
        },
        {
          id: 6,
          title: 'Educación Ambiental',
          description:
            'Programas educativos para promover la conciencia ambiental en la población.',
          icon: '📚'
        },
        {
          id: 7,
          title: 'Reforestación',
          description:
            'Iniciativas de plantación de árboles para recuperar áreas degradadas.',
          icon: '🌱'
        },
        {
          id: 8,
          title: 'Control de Contaminación',
          description:
            'Supervisión y control de actividades que generen contaminación ambiental.',
          icon: '🚫'
        }
      ]
    ...
    >
      ...
      <View style={styles.content}>
        <Text style={styles.subtitle}>
          Conoce todos los servicios que ofrecemos para proteger nuestro medio
          ambiente
        </Text>
