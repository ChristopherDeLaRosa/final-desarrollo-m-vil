...
export default function AboutUsScreen() {
  const developers = [
    ...
    // TODO: Rafael que coloque sus detalles
    {
      ...
      telegram: 'https://t.me/maria_backend',
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.content}>
        <Card style={styles.introCard}>
          <Card.Content>
            ...
            <Text style={styles.introText}>
              Somos un equipo de estudiantes de desarrollo de software comprometidos con el 
              desarrollo de soluciones tecnológicas que contribuyan al cuidado del medio ambiente. 
              Esta aplicación fue desarrollada como proyecto final de la asignatura "Introducción al desarrollo móvil"
               impartida por el maestro Amadis Suarez Genao.
            </Text>
            <Text style={styles.introText}>
              Nuestro objetivo es crear herramientas digitales que faciliten la gestión ambiental 
              y promuevan la participación ciudadana en la protección de nuestros recursos naturales.
            </Text>
          </Card.Content>
        </Card>
        ...
        {developers.map((developer) => (
          <Card key={developer.id} style={styles.developerCard}>
            <Card.Content style={styles.developerContent}>
              <View style={styles.developerHeader}>
                <Image source={{ uri: developer.image }} style={styles.developerImage} />
                <View style={styles.developerInfo}>
                  <Title style={styles.developerName}>{developer.name}</Title>
                  <Text style={styles.developerRole}>{developer.role}</Text>
                  <Text style={styles.developerMatricula}>Matrícula: {developer.matricula}</Text>
                </View>
              </View>
          ...
          <Card.Content>
            ...
            <View style={styles.projectInfo}>
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoValue}>Instituto Tecnológico de las Américas (ITLA)</Text>
              </View>
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>Carrera:</Text>
                <Text style={styles.infoValue}>Tecnólogo en Desarrollo de Software</Text>
              </View>
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>Materia:</Text>
                <Text style={styles.infoValue}>Introducción al desarrollo móvil</Text>
              </View>
              <View style={styles.infoRow}>
              ...
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoValue}>React Native, Expo, Node.js</Text>
              </View>
            </View>
          </Card.Content>
        </Card>
