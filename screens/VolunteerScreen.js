...
export default function VolunteerScreen() {
  ...
  const validateForm = () => {
    ...
    else if (cedDigits.length !== 11) e.cedula = 'La cédula debe tener 11 dígitos';
    ...
    else if (!emailRegex.test(formData.email)) e.email = 'Ingrese un correo electrónico válido';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setIsLoading(false);
      Alert.alert('Error', error.message || 'Hubo un problema al enviar tu solicitud.');
    }
  };
      ...
      <ScrollView style={styles.scrollView} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.content}>
          ...
          <Card style={styles.requirementsCard}>
            <Card.Content>
              <Title style={styles.cardTitle}>Requisitos para ser Voluntario</Title>
              {[
                ...
                <View key={t} style={styles.requirementItem}>
          ...
          <Card style={styles.formCard}>
            <Card.Content>
              ...
              />
              <HelperText type="error" visible={!!errors.cedula}>{errors.cedula}</HelperText>
              ...
              <Text style={styles.sectionTitle}>Experiencia Previa en Voluntariado</Text>
              <RadioButton.Group
                onValueChange={(value) => updateFormData('experience', value)}
                value={formData.experience}
              >
                <View style={styles.radioItem}><RadioButton value="none" /><Text style={styles.radioLabel}>Sin experiencia</Text></View>
                <View style={styles.radioItem}><RadioButton value="some" /><Text style={styles.radioLabel}>Alguna experiencia</Text></View>
                <View style={styles.radioItem}><RadioButton value="extensive" /><Text style={styles.radioLabel}>Experiencia extensa</Text></View>
              </RadioButton.Group>
...
const styles = StyleSheet.create({
  ...
  requirementIcon: { fontSize: 16, color: '#2E7D32', marginRight: 10, fontWeight: 'bold' },
  ...
  nameField: { flex: 1 },
  sectionTitle: { fontSize: 16, fontWeight: 'bold', color: '#2E7D32', marginTop: 15, marginBottom: 10 },
