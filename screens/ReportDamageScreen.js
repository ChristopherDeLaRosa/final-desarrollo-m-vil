...
import {
  TextInput, Button, Card, Title, HelperText,
...
export default function ReportesDamageScreen({ navigation }) {
  ...
  const validateForm = () => {
    ...
    if (!formData.latitude || !formData.longitude) e.location = 'La ubicación es requerida';
  ...
  const pickImage = async () => {
    ...
    if (!result.canceled) {
      ...
      setFormData(prev => ({ ...prev, photo: { uri: asset.uri, base64: asset.base64 } }));
        ...
        <View style={styles.content}>
          <Card style={styles.infoCard}>
            <Card.Content>
              ...
              <Text style={styles.infoText}>
                ...
                • Incluye una foto clara del daño ambiental{'\n'}
                • La ubicación nos ayuda a responder más rápido{'\n'}
          ...
          <Card style={styles.formCard}>
            <Card.Content>
              ...
              <HelperText type="error" visible={!!errors.photo}>{errors.photo}</HelperText>
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#d32f2f', padding: 20, alignItems: 'center', marginTop: 40 },
  ...
  locationContainer: { backgroundColor: '#e8f5e8', padding: 15, borderRadius: 8, marginBottom: 10 },
  locationText: { fontSize: 14, color: '#2E7D32', marginBottom: 10, textAlign: 'center' },
